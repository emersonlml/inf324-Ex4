...
<body class="loggedin">
    <nav class="navtop">
        <h1 style="color:black;">ejer 4</h1>
       ...
       $tip_us = $_SESSION['name']; 
        ...
        while ($fila = $resultado->fetch_assoc()) {
            ...
            if($rol=="docente"){
               ...
               $nomest=mysqli_query($con,"select estudiante.nombre from estudiante, nota where estudiante.id_est = notas.estudiante_id_est");
                if ($fila2 = $nota->fetch_assoc()) {
                    echo "Estudiante 1: " . $fila2['est_1'] . "<br>";
                    echo "Estudiante 2: " . $fila2['est_2'] . "<br>";
                    echo "Estudiante 3: " . $fila2['est_3'] . "<br>";
                }
            }
